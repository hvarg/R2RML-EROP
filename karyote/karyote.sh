...
grep -Ev 'unidentified|resource:>|""\^\^' karyote.nt | sort -u > result.nt
mv result.nt karyote.nt
cat <<EOT >> karyote.nt
<http://bio2rdf.org/erop_vocabulary:source_karyote> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2000/01/rdf-schema#Property> .
