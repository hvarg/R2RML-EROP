...
grep -Ev 'unidentified|resource:>|""\^\^' class.nt > result.nt
sort -u result.nt > class.nt
rm result.nt
cat <<EOT >> class.nt
<http://bio2rdf.org/erop_vocabulary:source_class> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2000/01/rdf-schema#Property> .
