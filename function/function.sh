...
cd function
grep -Ev 'unknown|unidentified|resource:>|""\^\^' function.nt > result.nt
sort -u result.nt > function.nt
rm result.nt
cat <<EOT >> function.nt
<http://bio2rdf.org/erop_vocabulary:function_class> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2000/01/rdf-schema#Property> .
